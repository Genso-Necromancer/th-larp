...
enum EFFECT_SOURCE {NONE,BUFF,ITEM,AURA}

#Passive Enums
enum PASSIVE_TYPE {NONE, VANTAGE, STAT_CHANGE, AURA, RESPONSE, FATED, SUB_WEAPON, NIGHT_PROT, DAY_PROT, PASS, LOCKPICK, CANTO, VENGEANCE, COUNTER,}
